...
return array(
    ...
    'metaTags' => [
		'landing' => [
        	'keywords'     => 'ilfate ilya rubinchik ilya_rubinchik php web developer',
		...
		'guess' => [
			...
			'description'    => 'Quiz: Guess series game',
			'og:site_name'   => 'GuessSeries',
			'og:title'       => 'Guess Series - the game where you can show your knowledge in series',
			'og:url'         => 'http://ilfate.net/GuessSeries',
		...
		'mathEffect' => [
        	'keywords'       => 'MathEffect, game, logic, strategy game, ilfate, ilya rubinchik, ilya_rubinchik, php, web developer',
		...
		'mageSurvival' => [
			...
			'og:image'       => 'http://ilfate.net/images/game/mage/spellCraft.png',
			'og:description' => 'Play a game where you Have to craft magic spell to fight monsters and travel through the worlds',
			'og:type'        => 'game',
		],
		'td' => [
			'keywords'       => 'TD TowerDefence tower defence game build towers survive grid',
			'description'    => 'TD - TowerDefence game. Build towers. Survive as long as you can!',
			'og:site_name'   => 'TD',
