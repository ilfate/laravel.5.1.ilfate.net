...
return array(
    ...
    'waves' => [
        ...
        10 => ['name' => 'Fast 8HP', 'min' => 4, 'max' => 4, 'types' => ['f2'], 'turns' => 3, 'skipTurns' => 10, 'newTower' => 'TBlueBolder'],
        11 => ['name' => 'Boss 16HP', 'min' => 1, 'max' => 1, 'types' => ['b3'], 'turns' => 1, 'skipTurns' => 16, 'newTower' => 'TBlueCanon'],
    ],
    'monsters' => [
        'b1' => ['health'=> 3, 'moneyAward'=> 10, 'color'=> $color['purple']],
        'b2' => ['health'=> 6, 'moneyAward'=> 15, 'color'=> $color['purple']],
        'b3' => ['health'=> 16, 'moneyAward'=> 25, 'color'=> $color['purple']],
